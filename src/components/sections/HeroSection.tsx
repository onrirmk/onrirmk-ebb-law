  ...
  return (
    <section className="relative isolate w-full overflow-hidden">
      ...
      >
        ...
        <div className="absolute inset-0 mx-auto flex max-w-[1680px] flex-col items-start justify-start px-6 pt-[200px] md:pl-[180px] md:pr-[96px] md:pt-[calc(38vh-60px)] lg:pl-[220px] xl:pl-[280px]">
