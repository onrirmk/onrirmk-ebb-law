  ...
  return (
    <section className="relative isolate w-full overflow-hidden">
      ...
      >
        ...
        <div className="absolute inset-0 mx-auto flex max-w-[1680px] flex-col items-start justify-start px-6 pt-[240px] md:pl-[240px] md:pr-[96px] md:pt-[calc(38vh-20px)] lg:pl-[280px] xl:pl-[340px]">
