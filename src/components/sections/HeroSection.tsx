  ...
  return (
    <section className="relative isolate w-full overflow-hidden">
      ...
      >
        ...
        <div className="absolute inset-0 mx-auto flex max-w-[1680px] flex-col items-start justify-start px-6 pt-[240px] md:pl-[260px] md:pr-[96px] md:pt-[calc(38vh-20px)] lg:pl-[300px] xl:pl-[360px]">
          <h1 className="font-sans font-semibold tracking-[-0.2px] text-white">
            ...
            <FadeIn variant="slideUp" immediate duration={900} delay={180}>
              <span className="mt-[8px] block max-w-[1280px] text-[clamp(24px,2.5vw,40px)] leading-[1.4] md:mt-[12px]">
                {titleLine2}
              </span>
            </FadeIn>
          </h1>
