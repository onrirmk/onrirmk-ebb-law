  ...
  return (
    ...
    >
      <p
        key={activeIndex}
        aria-live="polite"
        className="font-sans text-[16px] font-normal italic leading-[28px] tracking-[0.06px] text-[#1C1B1F] animate-in fade-in duration-300 md:text-[18px] md:leading-[30px]"
      >
        {active.quote}
      </p>
