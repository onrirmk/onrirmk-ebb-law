...
export function PracticeAreasHero({ eyebrow, title, subtitle }: Props) {
  return (
    <section className="w-full bg-[#212C60] text-white">
      <div className="mx-auto flex h-[280px] max-w-[1440px] flex-col items-center justify-center px-[24px] text-center md:h-[400px] md:px-[100px]">
        ...
        {subtitle ? (
          <p className="mt-[16px] max-w-[760px] font-sans text-[16px] font-normal leading-[26px] text-white/80 md:mt-[20px] md:text-[18px] md:leading-[30px]">
            {subtitle}
          </p>
        ) : null}
        <div
