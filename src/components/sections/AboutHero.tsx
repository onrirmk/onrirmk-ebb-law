...
export function AboutHero({ eyebrow, title }: Props) {
  return (
    <section className="w-full bg-[#212C60] text-white">
      <div className="mx-auto flex h-[280px] max-w-[1440px] flex-col items-center justify-center px-[24px] text-center md:h-[420px] md:px-[100px]">
